...
public class CalcUnclearedBilledAmtDAOImpl implements CalcUnclearedBilledAmtDAO {
	...
	private static final String FIND_ALL = " SELECT LTRIM(RTRIM(c.POLICY_PREFIX_1)) + LTRIM(RTRIM(c.POLICY_PREFIX_2)) + LTRIM(RTRIM(c.POLICY_NUMBER)) + '-' + LTRIM(RTRIM(c.POLICY_SUFFIX)) as REFERENCE_NUMBER ,   "
