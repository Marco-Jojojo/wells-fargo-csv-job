...
public class CalcUnclearedUnBilledCreditAmtDAOImpl implements CalcUnclearedUnBilledCreditAmtDAO {
	...
	private static final String FIND_ALL = " SELECT CONCAT(LTRIM(RTRIM(POLICY_PREFIX_1)), LTRIM(RTRIM(POLICY_PREFIX_2)), LTRIM(RTRIM(POLICY_NUMBER)), '-', LTRIM(RTRIM(POLICY_SUFFIX))) as REFERENCE_NUMBER , "
